...
public final class CommunicationReference {
	...
	public static final byte CLIENT_SEND_SYNCHRONOUS = 0x03;
	public static final byte CLIENT_SEND_ASYNCHRONOUS = 0x04;
	public static final byte CLIENT_REQUEST_UPDATE = 0x05;
